...
def save_upload_image(fileObj):
    ...
    # Use /tmp directory instead of static/media
    upload_image_path = os.path.join('/tmp', save_filename)
...
class DocumentScan():
    ...
    def document_scanner(self, image_path):
        ...
        # Save resized image to /tmp
        cv2.imwrite('/tmp/resize_image.jpg', img_re)
